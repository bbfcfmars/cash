  <div className="relative isolate overflow-hidden bg-white">
    <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
      <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
        ...
        <h1 className="mt-10 text-4xl font-bold tracking-tight text-mute-navy sm:text-6xl">
        ...
        <div className="mt-10 flex items-center gap-x-6">
          <a
            href="/signup"
            className="rounded-md bg-turtle px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-mute-turtle focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-mute-turtle"
          >
            Get started
          </a>
          <a href="/how-it-works" className="text-sm font-semibold leading-6 text-navy">
