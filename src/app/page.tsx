          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            ...
            <div className="lg:w-1/2">
              <div className="relative w-full h-[400px]">
                <Image
                  src="/hero-image.svg"
                  alt="Click.Save.Shop. browser extension showing savings"
                  fill
...
const features = [
  ...
  {
    icon: <svg className="w-6 h-6 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>,
