      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">Join Click.Save.Shop. Today</h1>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">Join over 17 million members saving money with Click.Save.Shop.</p>
                  </div>
                </div>
              </div>
